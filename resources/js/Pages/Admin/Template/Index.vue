                    ...
                    <table class="w-full text-sm text-left">
                        ...
                        <tr class="bg-white border-b " v-for="template in templates.data" :key="template.id">
                            ...
                            <td class="py-4 px-6">
                                ...
                                <button type="button" class="py-2 px-3 mr-1 text-xs font-medium text-center text-white bg-green-700 rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Edit</button>
